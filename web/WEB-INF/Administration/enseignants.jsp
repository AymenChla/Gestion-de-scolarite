                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.enseignants}" var="enseignant">
                            <tr>
                                <td><c:out value="${enseignant.getNomEnseignant()}" /></td>
                                <td><c:out value="${enseignant.getPrenomEnseignant()}" /></td>
                                <td><c:out value="${enseignant.getEmailEnseignant()}" /></td>
                                <td><c:out value="${enseignant.getDepartementEnseignant()}" /></td>
                                <td><c:out value="${enseignant.getTelEnseignant()}" /></td>
                                <td><c:out value="${enseignant.getSpecialiteEnseignant()}" /></td>
                                <td><c:out value="${enseignant.getAdresseEnseignant()}" /></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    <tfoot>
