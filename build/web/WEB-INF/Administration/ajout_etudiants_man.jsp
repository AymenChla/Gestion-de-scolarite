          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form enctype="multipart/form-data" role="form" action="Etudiant?page=insert" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="cne">CNE</label>
                      <input name="cne" type="text" class="form-control" id="cne" placeholder="CNE">
                    </div>
                    <div class="form-group">
                      <label for="codeApoge">Code Apogé</label>
                      <input name="codeApoge" type="text" class="form-control" id="codeApoge" placeholder="Code Apogé">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="idSemester">Semèstre</label>
                      <select class="form-control" id="idSemester" name="idSemester">
                          <c:forEach items="${filieres}" var="f">
                              <option value="<c:out value="${f.getIdSemester()}" />" ><c:out value="${f.getNomFiliere()} S${f.getSemester()}" /></option>
                          </c:forEach>
                      </select>
                    </div>
                     <div class="form-group">
